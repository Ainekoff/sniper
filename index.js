...
client.on('message', async (message) => {
    ...
    if (command === "start-snipe") {
        ...
        if (!message.guild.features.includes('VANITY_URL')) {
            return message.reply("Vous ne possédez pas assez de boost pour commencer un snipe !");
        };
...
client.login("OTE1NTc1NTY5ODkzMTg3NjE0.YadmMg.apOu2ynt-fELWD7tsDxStKV8brc"); //Head to https://discord.com/developers/applications
